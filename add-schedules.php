...
if(isset($_POST['sub'])){
    ...
    mysqli_query($con,"insert into `schedules`(group_id,title,description,note,date)values('$group_id','$title','$description','$note','$date')");
...
<html lang="en">
  ...
  ?>
    <main class="app-content">
      ...
      <div class="col-md-6">
          <div class="tile">
            <h3 class="tile-title">Add Review Schedules</h3>
            <div class="tile-body">
              <form method="post">
              <div class="form-group">
                    ...
                    <select class="form-control" name="group" id="exampleSelect1" required>
                      <option aria-readonly="">Select Group</option>
                        ...
                        ?>
                      <option value="<?php echo $dat0['login_id'] ?>"><?php echo $dat0['name'] ?></option>
                      <?php
                        }
                       ?>
                    </select>
